    ...
    <div class="container">
        <div class="row">
            ...
            <aside class="col-lg-3">
                ...
                <!-- CATEGORY SAME -->
                <h4 class="pro-cotton__title">Danh mục liên quan</h4>
                <ul class="pro-menu__list mb-4">
                    <php:forEach items="${categorySames}" var="cate">
                        <li class="pro-menu__item">
                            <a href="category?id=${cate.getId()}"
                               class="text-danger">
            ...
            <main class="col-lg-9">
                ...
                <!-- CATEGORY NAME -->
                <h3 class="pro-cotton__theme text-uppercase mb-4">
                    ${category}
                </h3>
